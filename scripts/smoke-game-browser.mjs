...
try {
 ...
 await page.screenshot({path:'/tmp/bis-game-account.png'});
 ...
 await page.screenshot({path:'/tmp/bis-game-account-narrow.png'});
...
} catch(e){console.log('FAIL:',e.message);console.log('page errors:',JSON.stringify(errors));await page.screenshot({path:'/tmp/bis-game-failure.png'});process.exitCode=1;}
