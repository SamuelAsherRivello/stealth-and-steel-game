...
- Standardize menu internals: 20px heading-content indents, clear banner-to-content spacing, doubled one-line-fit banner titles, reduced action-button gaps, and fixed bottom action padding. Map-order sub-buttons remain excluded from the regular action-button gap rule.
...
- Covers the start menu, treasure menu, loss and level-complete outcomes, settings/developer windows, and their shared action buttons.
