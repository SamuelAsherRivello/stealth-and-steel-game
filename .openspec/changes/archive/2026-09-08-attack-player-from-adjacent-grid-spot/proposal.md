...
Cardinal adjacency retains attack priority in all awareness states, subject to the later C060 concealment rule: a hidden player is eligible only while this enemy has its own unexpired visually confirmed ALERT. Revalidate concealment through centering before commitment. Earlier descriptions of awareness-independent combat do not override this exception.
