...
- [x] `C051-T004` Run focused tests, the complete test suite, and a real-browser smoke check with perception diagnostics enabled.

Verification on 2026-09-08: 40 focused tests and all 958 suite tests passed, production build passed, and the browser perception diagnostic scene passed for all five enemies. See verification.md for fixes and evidence.
