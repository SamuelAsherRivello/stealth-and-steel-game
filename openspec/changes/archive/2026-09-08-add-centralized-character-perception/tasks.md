...
Visual perception follows movement heading and current terrain/bush/enemy blockers. Audio crosses terrain but excludes hidden players and cells blocked by living enemies. Accepted evidence can escalate reactions, and recovery de-escalates through investigation and suspicion; first-event-only handling is superseded.
