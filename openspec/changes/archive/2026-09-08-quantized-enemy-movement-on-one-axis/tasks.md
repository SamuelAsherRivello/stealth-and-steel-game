...
- [x] 3.1 C052-T007 Verify all enemy movement colliders, grid occupancy, and render depth remain coherent after horizontal and vertical movement; run the complete automated test suite.
- [x] 3.2 C052-T008 Run a browser smoke test with the enemy types and verify visible one-axis centerline movement, obstacle handling, attacks, and no regressions.

## Verification status (2026-09-08)

See verification.md for the movement, depth, occupancy, browser and build evidence. C052-T008 passed for all five enemy types. C052-T007 is complete: all 117 focused movement/attack/spatial tests and all 952 tests in the complete suite passed after updating stale settings-test selectors. All eight tasks are complete.
