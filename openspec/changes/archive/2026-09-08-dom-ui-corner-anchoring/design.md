...
Retain the shared 25 px inset, version upper-left, Settings upper-right and Move lower-left. Attack is the sole lower-right action while Item is temporarily unavailable, with no blank Item slot. References below to a paired Item/Attack unit describe the earlier layout and are superseded by this current contract.
