...
The viewport system SHALL expose a QA flag that enables four-corner markers for the game frame, fitted tilemap viewport, debug viewport, and DOM viewport, plus runtime rectangle logs for all three layers.
