...
import { canEnemyTargetPlayer, getOccupiedBushBlockers } from '../../runtime/systems/perception/player-hidden.js';
...
const bushAtlas = await loadSpriteAtlas(engine, '/assets/images/terrain/decorations/bushes/Bushe1-frame0.png', { gridSize: [64, 64], sampling: 'nearest' });
const records = [];
