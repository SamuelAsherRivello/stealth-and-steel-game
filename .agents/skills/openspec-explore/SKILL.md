...
**Canonical identity:** Names are the preferred interface, but accept and
display `C###` IDs. Preserve existing change and `C###-T###` task IDs; new
changes and tasks must receive IDs during creation.
